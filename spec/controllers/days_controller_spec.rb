...
describe DaysController do
  ...
  let(:valid_attributes) { { "date" => "2014-11-20 13:14:55" } }
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested day" do
        ...
        Day.any_instance.should_receive(:update).with({ "date" => "2014-11-20 13:14:55" })
        put :update, {:id => day.to_param, :day => { "date" => "2014-11-20 13:14:55" }}, valid_session
      end
